(() => {
    ...
    function initSliders() {
        if (document.querySelector(".block-page__slider")) new core(".block-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".block-page__arrow.swiper-button-prev",
                nextEl: ".block-page__arrow.swiper-button-next"
            },
            breakpoints: {
                992: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".column-block__slider")) new core(".column-block__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".column-block__arrow.swiper-button-prev",
                nextEl: ".column-block__arrow.swiper-button-next"
            },
            breakpoints: {
                992: {
                    slidesPerView: 1,
